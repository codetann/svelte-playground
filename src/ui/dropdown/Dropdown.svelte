...
<div class="relative">
  ...
  <button
    class="relative z-10 block p-2 bg-white rounded-md dark:bg-gray-800 focus:outline-none hover:bg-gray-200 transition duration-200"
  ...
  {#if isActive}
    <div
      ...
      class="absolute left-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-md dark:bg-gray-800"
    >
      <a
        href="#"
